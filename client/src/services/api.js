...
const API_BASE = import.meta.env.PROD ? '/api' : (import.meta.env.VITE_API_URL ? `${import.meta.env.VITE_API_URL}/api` : '/api');
...
export const projectAPI = {
    ...
    releaseFinalBill: (id, data) => api.put(`/projects/${id}/final-bill/release`, data),
